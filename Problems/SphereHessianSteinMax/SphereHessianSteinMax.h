...
#ifndef SPHEREHESSIANSTEINMAX_H
#define SPHEREHESSIANSTEINMAX_H
...
namespace ROPTLIB{
	...
	class SphereHessianSteinMax : public Problem{
	public:
		...
		SphereHessianSteinMax(double *inCs, double *inDs, integer inn, integer innum);
		virtual ~SphereHessianSteinMax();
