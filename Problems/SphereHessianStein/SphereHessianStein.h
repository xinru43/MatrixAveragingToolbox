...
#ifndef SPHEREHESSIANSTEIN_H
#define SPHEREHESSIANSTEIN_H
...
namespace ROPTLIB{
	...
	class SphereHessianStein : public Problem{
	public:
		...
		SphereHessianStein(double *inCs, double *inDs, integer inn, integer innum);
		virtual ~SphereHessianStein();
        ...
        virtual double dis(Variable *x) const; 

        virtual double distwo(Variable *x, Variable *y) const; 
