...
#ifndef SPDMEANSYMMLDONEPARAMLinfty_H
#define SPDMEANSYMMLDONEPARAMLinfty_H
...
namespace ROPTLIB{
	...
	class SPDMeanSymmLDOneParamLinfty : public Problem{
	public:
		...
		SPDMeanSymmLDOneParamLinfty(double *inLs, double *inLDAs, integer inn, integer innum, double inalpha);
		virtual ~SPDMeanSymmLDOneParamLinfty();
