...
#ifndef SPDMEANSYMMLDONEPARAM_H
#define SPDMEANSYMMLDONEPARAM_H
...
namespace ROPTLIB{
	...
	class SPDMeanSymmLDOneParam : public Problem{
	public:
		...
		SPDMeanSymmLDOneParam(double *inLs, integer inn, integer innum, double inalpha);
		virtual ~SPDMeanSymmLDOneParam();
