...
#ifndef SPDMEANSTEINV2_H
#define SPDMEANSTEINV2_H
...
namespace ROPTLIB{
	...
	class SPDMeanSteinV2 : public Problem{
	public:
		...
		SPDMeanSteinV2(double *inLs, integer inn, integer innum);
		virtual ~SPDMeanSteinV2();
