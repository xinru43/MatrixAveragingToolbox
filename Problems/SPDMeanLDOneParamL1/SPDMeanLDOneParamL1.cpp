...
namespace ROPTLIB{
    ...
    {        
        ...
        for (integer i = 0; i < num; i++)
        {
            ...
            // add scaled inv(LplusX) to gfVT
            coef = 0.5/coef1[i];
            dgemm_(GLOBAL::N, GLOBAL::N, &N, &N, &N, &coef, iLplusX + n * n * i, &N, I, &N, &GLOBAL::DONE, gfVT, &N);
