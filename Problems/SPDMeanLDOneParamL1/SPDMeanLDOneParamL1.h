...
#ifndef SPDMEANLDONEPARAML1_H
#define SPDMEANLDONEPARAML1_H
...
namespace ROPTLIB{
	...
	class SPDMeanLDOneParamL1 : public Problem{
	public:
		...
		SPDMeanLDOneParamL1(double *inLs, double *inLDAs, integer inn, integer innum, double inalpha);
		virtual ~SPDMeanLDOneParamL1();
