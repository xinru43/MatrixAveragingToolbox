...
#ifndef SPDMEANSTEIN_H
#define SPDMEANSTEIN_H
...
namespace ROPTLIB{
	...
	class SPDMeanStein : public Problem{
	public:
		...
		SPDMeanStein(double *inLs, double *inXtrue, integer inn, integer innum);
		virtual ~SPDMeanStein();
