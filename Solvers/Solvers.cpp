...
namespace ROPTLIB{
	...
	void Solvers::OutPutResults(Variable *inx1, double &inf1, double &inngf0, double &inngf, integer &initer,
		...
		double *intimeSeries, double *infunSeries, double *ingradSeries, double *indistSeries, integer &inlengthSeries,
            double *ininitstepsizeSeries, double *instepsizeSeries)
	{
        ...
        ininitstepsizeSeries = initstepsizeSeries; instepsizeSeries = stepsizeSeries; 
	};
	...
	void Solvers::Run(void)
	{
		...
		if (Debug >= ITERRESULT)
		{
            ...
            if (initstepsizeSeries == nullptr)
				delete[] initstepsizeSeries;
			initstepsizeSeries = new double[1 + Max_Iteration];
            if (stepsizeSeries == nullptr)
				delete[] stepsizeSeries;
			stepsizeSeries = new double[1 + Max_Iteration];
	...
	void Solvers::SetDefaultParams()
	{
		...
		StopPtr = nullptr; initstepsizeSeries = nullptr; stepsizeSeries = nullptr;
