...
namespace ROPTLIB{
	...
	*/
	...
	public:
        ...
        inline double *GetinitstepsizeSeries(void) const { return initstepsizeSeries; };
        inline double *GetstepsizeSeries(void) const { return stepsizeSeries; };
	...
	protected:
		...
		double *timeSeries, *funSeries, *gradSeries, *distSeries, *initstepsizeSeries, *stepsizeSeries; /*four arrays to store the computational time, function values, norm of gradient
