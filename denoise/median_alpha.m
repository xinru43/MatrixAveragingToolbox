function [output, comtime] = median_alpha(As, alpha, TOL)
...
% compute the mean
[Xopt, f, gf, gfgf0, iter, nf, ng, nR, nV, nVp, nH, comtime] = TestSPDMeanLDOneParamL1(As, LDAs, alpha, x1, HasHHR, SolverParams);
