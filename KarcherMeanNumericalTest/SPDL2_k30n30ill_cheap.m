function SPDL2_k30n30ill_cheap

% number of data tested
Ndata = 50;

% specify the path of data and results
DataPath = sprintf('L2Results/k30n30ill/');
SavePath = sprintf('L2Results/k30n30illcheap/');
...
for times = 1 : Ndata
    ...
    if generate_new_data
        n = 30;
        k = 30;
        f = 6; % controls the condition number of data points
    ...
    % compute the cheap mean as the initial point
    x1 = cheap(As{1 : k});
    ...
    SolverParams.LS_ratio1 = 0.25;
    SolverParams.LS_ratio2 = 0.25;    
