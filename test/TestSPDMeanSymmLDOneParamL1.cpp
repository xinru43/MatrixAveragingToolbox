...
#include "TestSPDMeanSymmLDOneParamL1.h"
...
#if !defined(MATLAB_MEX_FILE) && defined(TESTSPDMEANSYMMLDONEPARAML1)
...
void testSPDMeanSymmLDOneParamL1(void)
{
    ...
    for (integer i = 0; i < num; i++) LDAs[i] = 0.0;
    
	// Define the problem
	SPDMeanSymmLDOneParamL1 Prob(Ls, LDAs, n, num, alpha);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	SPDMeanSymmLDOneParamL1 Prob(Ls, LDAs, n, N, alpha);
	Prob.SetDomain(&Domain);
