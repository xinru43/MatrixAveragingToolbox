...
#if !defined(MATLAB_MEX_FILE) && defined(TESTSPDMEANLINFTYAN)
...
void testSPDMeanLinftyAN(void)
{
    printf("============= Minimax center computation by AN method =============\n");
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    Debug = static_cast<integer>(mxGetScalar(prhs[7]));
