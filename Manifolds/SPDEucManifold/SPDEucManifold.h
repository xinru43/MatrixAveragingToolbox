/*
This file defines the class for the manifold of symmetric positive definite matrices (SPDEucManifold).
...
---- WH
*/
#ifndef SPDEUCMANIFOLD_H
#define SPDEUCMANIFOLD_H
...
namespace ROPTLIB{
	...
	class SPDEucManifold : public Manifold{
	public:
		/*Construct the SPD manifold*/
		SPDEucManifold(integer inn);

		/*Delete EMPTYINTR and EMPTYEXTR*/
		virtual ~SPDEucManifold(void);
        ...
        virtual double EucDist(Variable *x1, Variable *x2) const;
